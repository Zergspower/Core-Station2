...
/mob/living/simple_mob/vore/newdeer
	name = "space deer"
...
/mob/living/simple_mob/vore/newdeer/Bumped(atom/movable/AM, yes)
...
/mob/living/simple_mob/vore/newdeer/update_icon()
	. = ..()
	if(run_over)
		icon_state = "deer_dead_alt"

/mob/living/simple_mob/vore/newdeer/Crossed(atom/movable/AM)
	if(istype(AM, /obj/vehicle) && stat != DEAD)
		run_over = TRUE
		visible_emote("is run over by \the [AM]!!!")
		death()
